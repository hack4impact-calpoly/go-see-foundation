  ...
  return (
    <div className={styles.about}>
      <h1 className={styles.title} tabIndex={0}>
        Allyson Buerger - The Founder
      </h1>
      <div className={styles.introWrapper}>
        <div className={styles.introduction}>
          <div className={styles.firstHalf} tabIndex={0}>
            ...
            <div className={styles.text}>
              <p tabIndex={0}>
                ...
                with a mission to encourage, inspire, and empower those who are
                blind or visually impaired to remain active and engaged with the
                world. I’ve been dealing with vision loss for as long as I can
                remember and am now legally blind. I have had 29 eye surgeries,
                been diagnosed with juvenile inflammatory arthritis, uveitis,
                glaucoma, cataracts, and my right eye is now a prosthetic.
                Throughout my vision journey, I have experienced the life
                changing uncertainty and challenges that come with losing your
                sight.
              </p>
              <p tabIndex={0}>
          ...
          <p tabIndex={0}>
            ...
            the Central Coast have enjoyed tandem kayaking, trail hikes, cooking
            lessons, birding by ear, zip-lining, and other tactile experiences.
            These activities are meant to tap into our other senses in fun ways
            and forge a community where people with vision loss can support each
          ...
          <p tabIndex={0}>
            ...
            donation on our website. If your business or company would like to
            support or host an event please reach out! Email:
            allyson@goseefoundation.org Phone: (805) 242- 4220.
          </p>
        </div>
      </div>
      <div tabIndex={0}>
      ...
      <div className={styles.podcast} tabIndex={0}>
        <h1 className={`${styles.header} ${styles.podcastHeader}`} tabIndex={0}>
          Listen to Our Podcast - Episode 3 out now!
        </h1>
        <div className={styles.podcastContent} tabIndex={0}>
